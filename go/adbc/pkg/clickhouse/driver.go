...
//
// int ClickHouseArrayStreamGetSchema(struct ArrowArrayStream*, struct ArrowSchema*);
// int ClickHouseArrayStreamGetNext(struct ArrowArrayStream*, struct ArrowArray*);
// const char* ClickHouseArrayStreamGetLastError(struct ArrowArrayStream*);
// void ClickHouseArrayStreamRelease(struct ArrowArrayStream*);
//
// int ClickHouseArrayStreamGetSchemaTrampoline(struct ArrowArrayStream*, struct ArrowSchema*);
// int ClickHouseArrayStreamGetNextTrampoline(struct ArrowArrayStream*, struct ArrowArray*);
//
...
import (
	...
	"github.com/apache/arrow-adbc/go/adbc/driver/clickhouse"
...
var drv = clickhouse.NewDriver(mallocator.NewMallocator())
...
const errPrefix = "[ClickHouse] "
const logLevelEnvVar = "ADBC_DRIVER_CLICKHOUSE_LOG_LEVEL"
...
func setErr(err *C.struct_AdbcError, format string, vals ...interface{}) {
	...
	if err.release != nil {
		C.ClickHouseerrRelease(err)
	}

	msg := errPrefix + fmt.Sprintf(format, vals...)
	err.message = C.CString(msg)
	err.release = (*[0]byte)(C.ClickHouse_release_error)
}
...
func setErrWithDetails(err *C.struct_AdbcError, adbcError adbc.Error) {
	...
	cErrPtr := C.malloc(C.sizeof_struct_ClickHouseError)
	cErr := (*C.struct_ClickHouseError)(cErrPtr)
	cErr.message = C.CString(adbcError.Msg)
	err.message = cErr.message
	err.release = (*[0]byte)(C.ClickHouseReleaseErrWithDetails)
...
func poison(err *C.struct_AdbcError, fname string, e interface{}) C.AdbcStatusCode {
	if !globalPoison.Swap(true) {
		...
		fmt.Fprintf(os.Stderr, "ClickHouse driver panicked, stack traces:\n%s", buf[:length])
	}
	setErr(err, "%s: Go panic in ClickHouse driver (see stderr): %#v", fname, e)
...
func initLoggingFromEnv(db adbc.Database) {
	...
	if !ok {
		logger.Error("ClickHouse does not support logging")
		return
	}
...
func printLoggingHelp() {
	fmt.Fprintf(os.Stderr, "ClickHouse: to enable logging, set %s to 'debug', 'info', 'warn', or 'error'", logLevelEnvVar)
}
...
func (cStream *cArrayStream) maybeError() C.int {
	...
	if err != nil {
		if cStream.adbcErr != nil {
			C.ClickHouseerrRelease(cStream.adbcErr)
		} else {
...
//export ClickHouseArrayStreamGetLastError
func ClickHouseArrayStreamGetLastError(stream *C.struct_ArrowArrayStream) *C.cchar_t {
	if stream == nil || stream.release != (*[0]byte)(C.ClickHouseArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
...
//export ClickHouseArrayStreamGetNext
func ClickHouseArrayStreamGetNext(stream *C.struct_ArrowArrayStream, array *C.struct_ArrowArray) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.ClickHouseArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export ClickHouseArrayStreamGetSchema
func ClickHouseArrayStreamGetSchema(stream *C.struct_ArrowArrayStream, schema *C.struct_ArrowSchema) C.int {
	if stream == nil || stream.release != (*[0]byte)(C.ClickHouseArrayStreamRelease) || stream.private_data == nil {
		return C.EINVAL
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
//export ClickHouseArrayStreamRelease
func ClickHouseArrayStreamRelease(stream *C.struct_ArrowArrayStream) {
	if stream == nil || stream.release != (*[0]byte)(C.ClickHouseArrayStreamRelease) || stream.private_data == nil {
		return
	}
...
//export ClickHouseErrorFromArrayStream
func ClickHouseErrorFromArrayStream(stream *C.struct_ArrowArrayStream, status *C.AdbcStatusCode) *C.struct_AdbcError {
	if stream == nil || stream.release != (*[0]byte)(C.ClickHouseArrayStreamRelease) || stream.private_data == nil {
		return nil
	}
	cStream := getFromHandle[cArrayStream](stream.private_data)
...
func exportRecordReader(rdr array.RecordReader, stream *C.struct_ArrowArrayStream) {
	...
	stream.get_last_error = (*[0]byte)(C.ClickHouseArrayStreamGetLastError)
	stream.get_next = (*[0]byte)(C.ClickHouseArrayStreamGetNextTrampoline)
	stream.get_schema = (*[0]byte)(C.ClickHouseArrayStreamGetSchemaTrampoline)
	stream.release = (*[0]byte)(C.ClickHouseArrayStreamRelease)
...
//export ClickHouseDatabaseGetOption
func ClickHouseDatabaseGetOption(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseGetOptionBytes
func ClickHouseDatabaseGetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseGetOptionDouble
func ClickHouseDatabaseGetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseGetOptionInt
func ClickHouseDatabaseGetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseInit
func ClickHouseDatabaseInit(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseNew
func ClickHouseDatabaseNew(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseRelease
func ClickHouseDatabaseRelease(db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcDatabaseInit", e)
		}
...
//export ClickHouseDatabaseSetOption
func ClickHouseDatabaseSetOption(db *C.struct_AdbcDatabase, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseSetOptionBytes
func ClickHouseDatabaseSetOptionBytes(db *C.struct_AdbcDatabase, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseSetOptionDouble
func ClickHouseDatabaseSetOptionDouble(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDatabaseSetOptionInt
func ClickHouseDatabaseSetOptionInt(db *C.struct_AdbcDatabase, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionGetOption
func ClickHouseConnectionGetOption(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionGetOptionBytes
func ClickHouseConnectionGetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionGetOptionDouble
func ClickHouseConnectionGetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionGetOptionInt
func ClickHouseConnectionGetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionNew
func ClickHouseConnectionNew(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionSetOption
func ClickHouseConnectionSetOption(cnxn *C.struct_AdbcConnection, key, val *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionSetOptionBytes
func ClickHouseConnectionSetOptionBytes(db *C.struct_AdbcConnection, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionSetOptionDouble
func ClickHouseConnectionSetOptionDouble(db *C.struct_AdbcConnection, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionSetOptionInt
func ClickHouseConnectionSetOptionInt(db *C.struct_AdbcConnection, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionInit
func ClickHouseConnectionInit(cnxn *C.struct_AdbcConnection, db *C.struct_AdbcDatabase, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionRelease
func ClickHouseConnectionRelease(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionCancel
func ClickHouseConnectionCancel(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionGetInfo
func ClickHouseConnectionGetInfo(cnxn *C.struct_AdbcConnection, codes *C.cuint32_t, len C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionGetObjects
func ClickHouseConnectionGetObjects(cnxn *C.struct_AdbcConnection, depth C.int, catalog, dbSchema, tableName *C.cchar_t, tableType **C.cchar_t, columnName *C.cchar_t,
...
//export ClickHouseConnectionGetStatistics
func ClickHouseConnectionGetStatistics(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, approximate C.char, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionGetStatisticNames
func ClickHouseConnectionGetStatisticNames(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcConnectionGetStatistics", e)
		}
...
//export ClickHouseConnectionGetTableSchema
func ClickHouseConnectionGetTableSchema(cnxn *C.struct_AdbcConnection, catalog, dbSchema, tableName *C.cchar_t, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionGetTableTypes
func ClickHouseConnectionGetTableTypes(cnxn *C.struct_AdbcConnection, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionReadPartition
func ClickHouseConnectionReadPartition(cnxn *C.struct_AdbcConnection, serialized *C.cuint8_t, serializedLen C.size_t, out *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionCommit
func ClickHouseConnectionCommit(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseConnectionRollback
func ClickHouseConnectionRollback(cnxn *C.struct_AdbcConnection, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementGetOption
func ClickHouseStatementGetOption(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.char, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementGetOptionBytes
func ClickHouseStatementGetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.uint8_t, length *C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementGetOptionDouble
func ClickHouseStatementGetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementGetOptionInt
func ClickHouseStatementGetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementNew
func ClickHouseStatementNew(cnxn *C.struct_AdbcConnection, stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementRelease
func ClickHouseStatementRelease(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementCancel
func ClickHouseStatementCancel(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementPrepare
func ClickHouseStatementPrepare(stmt *C.struct_AdbcStatement, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementExecuteQuery
func ClickHouseStatementExecuteQuery(stmt *C.struct_AdbcStatement, out *C.struct_ArrowArrayStream, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementExecuteSchema
func ClickHouseStatementExecuteSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
			code = poison(err, "AdbcStatementExecuteQuery", e)
		}
...
//export ClickHouseStatementSetSqlQuery
func ClickHouseStatementSetSqlQuery(stmt *C.struct_AdbcStatement, query *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementSetSubstraitPlan
func ClickHouseStatementSetSubstraitPlan(stmt *C.struct_AdbcStatement, plan *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementBind
func ClickHouseStatementBind(stmt *C.struct_AdbcStatement, values *C.struct_ArrowArray, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementBindStream
func ClickHouseStatementBindStream(stmt *C.struct_AdbcStatement, stream *C.struct_ArrowArrayStream, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementGetParameterSchema
func ClickHouseStatementGetParameterSchema(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementSetOption
func ClickHouseStatementSetOption(stmt *C.struct_AdbcStatement, key, value *C.cchar_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementSetOptionBytes
func ClickHouseStatementSetOptionBytes(db *C.struct_AdbcStatement, key *C.cchar_t, value *C.cuint8_t, length C.size_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementSetOptionDouble
func ClickHouseStatementSetOptionDouble(db *C.struct_AdbcStatement, key *C.cchar_t, value C.double, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementSetOptionInt
func ClickHouseStatementSetOptionInt(db *C.struct_AdbcStatement, key *C.cchar_t, value C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseStatementExecutePartitions
func ClickHouseStatementExecutePartitions(stmt *C.struct_AdbcStatement, schema *C.struct_ArrowSchema, partitions *C.struct_AdbcPartitions, affected *C.int64_t, err *C.struct_AdbcError) (code C.AdbcStatusCode) {
	defer func() {
		if e := recover(); e != nil {
...
//export ClickHouseDriverInit
func ClickHouseDriverInit(version C.int, rawDriver *C.void, err *C.struct_AdbcError) C.AdbcStatusCode {
	...
	driver.DatabaseInit = (*[0]byte)(C.ClickHouseDatabaseInit)
	driver.DatabaseNew = (*[0]byte)(C.ClickHouseDatabaseNew)
	driver.DatabaseRelease = (*[0]byte)(C.ClickHouseDatabaseRelease)
	driver.DatabaseSetOption = (*[0]byte)(C.ClickHouseDatabaseSetOption)

	driver.ConnectionNew = (*[0]byte)(C.ClickHouseConnectionNew)
	driver.ConnectionInit = (*[0]byte)(C.ClickHouseConnectionInit)
	driver.ConnectionRelease = (*[0]byte)(C.ClickHouseConnectionRelease)
	driver.ConnectionSetOption = (*[0]byte)(C.ClickHouseConnectionSetOption)
	driver.ConnectionGetInfo = (*[0]byte)(C.ClickHouseConnectionGetInfo)
	driver.ConnectionGetObjects = (*[0]byte)(C.ClickHouseConnectionGetObjects)
	driver.ConnectionGetTableSchema = (*[0]byte)(C.ClickHouseConnectionGetTableSchema)
	driver.ConnectionGetTableTypes = (*[0]byte)(C.ClickHouseConnectionGetTableTypes)
	driver.ConnectionReadPartition = (*[0]byte)(C.ClickHouseConnectionReadPartition)
	driver.ConnectionCommit = (*[0]byte)(C.ClickHouseConnectionCommit)
	driver.ConnectionRollback = (*[0]byte)(C.ClickHouseConnectionRollback)

	driver.StatementNew = (*[0]byte)(C.ClickHouseStatementNew)
	driver.StatementRelease = (*[0]byte)(C.ClickHouseStatementRelease)
	driver.StatementSetOption = (*[0]byte)(C.ClickHouseStatementSetOption)
	driver.StatementSetSqlQuery = (*[0]byte)(C.ClickHouseStatementSetSqlQuery)
	driver.StatementSetSubstraitPlan = (*[0]byte)(C.ClickHouseStatementSetSubstraitPlan)
	driver.StatementBind = (*[0]byte)(C.ClickHouseStatementBind)
	driver.StatementBindStream = (*[0]byte)(C.ClickHouseStatementBindStream)
	driver.StatementExecuteQuery = (*[0]byte)(C.ClickHouseStatementExecuteQuery)
	driver.StatementExecutePartitions = (*[0]byte)(C.ClickHouseStatementExecutePartitions)
	driver.StatementGetParameterSchema = (*[0]byte)(C.ClickHouseStatementGetParameterSchema)
	driver.StatementPrepare = (*[0]byte)(C.ClickHouseStatementPrepare)

	if version == C.ADBC_VERSION_1_1_0 {
		driver.ErrorGetDetailCount = (*[0]byte)(C.ClickHouseErrorGetDetailCount)
		driver.ErrorGetDetail = (*[0]byte)(C.ClickHouseErrorGetDetail)
		driver.ErrorFromArrayStream = (*[0]byte)(C.ClickHouseErrorFromArrayStream)

		driver.DatabaseGetOption = (*[0]byte)(C.ClickHouseDatabaseGetOption)
		driver.DatabaseGetOptionBytes = (*[0]byte)(C.ClickHouseDatabaseGetOptionBytes)
		driver.DatabaseGetOptionDouble = (*[0]byte)(C.ClickHouseDatabaseGetOptionDouble)
		driver.DatabaseGetOptionInt = (*[0]byte)(C.ClickHouseDatabaseGetOptionInt)
		driver.DatabaseSetOptionBytes = (*[0]byte)(C.ClickHouseDatabaseSetOptionBytes)
		driver.DatabaseSetOptionDouble = (*[0]byte)(C.ClickHouseDatabaseSetOptionDouble)
		driver.DatabaseSetOptionInt = (*[0]byte)(C.ClickHouseDatabaseSetOptionInt)

		driver.ConnectionCancel = (*[0]byte)(C.ClickHouseConnectionCancel)
		driver.ConnectionGetOption = (*[0]byte)(C.ClickHouseConnectionGetOption)
		driver.ConnectionGetOptionBytes = (*[0]byte)(C.ClickHouseConnectionGetOptionBytes)
		driver.ConnectionGetOptionDouble = (*[0]byte)(C.ClickHouseConnectionGetOptionDouble)
		driver.ConnectionGetOptionInt = (*[0]byte)(C.ClickHouseConnectionGetOptionInt)
		driver.ConnectionGetStatistics = (*[0]byte)(C.ClickHouseConnectionGetStatistics)
		driver.ConnectionGetStatisticNames = (*[0]byte)(C.ClickHouseConnectionGetStatisticNames)
		driver.ConnectionSetOptionBytes = (*[0]byte)(C.ClickHouseConnectionSetOptionBytes)
		driver.ConnectionSetOptionDouble = (*[0]byte)(C.ClickHouseConnectionSetOptionDouble)
		driver.ConnectionSetOptionInt = (*[0]byte)(C.ClickHouseConnectionSetOptionInt)

		driver.StatementCancel = (*[0]byte)(C.ClickHouseStatementCancel)
		driver.StatementExecuteSchema = (*[0]byte)(C.ClickHouseStatementExecuteSchema)
		driver.StatementGetOption = (*[0]byte)(C.ClickHouseStatementGetOption)
		driver.StatementGetOptionBytes = (*[0]byte)(C.ClickHouseStatementGetOptionBytes)
		driver.StatementGetOptionDouble = (*[0]byte)(C.ClickHouseStatementGetOptionDouble)
		driver.StatementGetOptionInt = (*[0]byte)(C.ClickHouseStatementGetOptionInt)
		driver.StatementSetOptionBytes = (*[0]byte)(C.ClickHouseStatementSetOptionBytes)
		driver.StatementSetOptionDouble = (*[0]byte)(C.ClickHouseStatementSetOptionDouble)
		driver.StatementSetOptionInt = (*[0]byte)(C.ClickHouseStatementSetOptionInt)
	}
