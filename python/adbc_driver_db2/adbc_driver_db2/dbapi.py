...
"""
DBAPI 2.0-compatible facade for the ADBC DB2 driver.
"""
...
def connect(
    ...
    **kwargs,
    ...
    """
    Connect to IBM DB2 via ADBC.

    Parameters
    ----------
    uri : str, optional
        The DB2 CLI connection string, e.g.
    ...
    **kwargs
    ...
    try:
        db = adbc_driver_db2.connect(uri, db_kwargs=db_kwargs)
