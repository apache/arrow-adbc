...
build_subproject() {
    ...
    cmake "${source_dir}/c" \
          ...
          -DADBC_DRIVER_MGR_TEST_MANIFEST_SYSTEM_LEVEL="${ADBC_DRIVER_MANAGER_SYSTEM_CONFIG_TEST}" \
          -DADBC_DRIVER_MGR_TEST_MANIFEST_USER_LEVEL="${ADBC_DRIVER_MANAGER_USER_CONFIG_TEST}"
    set +x
