...
build_subproject() {
    ...
    cmake "${source_dir}/c" \
          ...
          -DADBC_BUILD_DRIVER_MANAGER="${BUILD_DRIVER_MANAGER}" \
          -DADBC_BUILD_DRIVER_POSTGRESQL="${BUILD_DRIVER_POSTGRESQL}" \
          -DADBC_BUILD_DRIVER_SQLITE="${BUILD_DRIVER_SQLITE}" \
          -DADBC_BUILD_DRIVER_FLIGHTSQL="${BUILD_DRIVER_FLIGHTSQL}" \
