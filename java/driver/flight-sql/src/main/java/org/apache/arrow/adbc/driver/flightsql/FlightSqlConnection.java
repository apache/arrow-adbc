...
public class FlightSqlConnection implements AdbcConnection {
  ...
  /**
   * Returns the Flight SQL client associated with this connection.
   *
   * <p>The returned client is owned by this connection and should not be closed independently.
   */
  public FlightSqlClientWithCallOptions getClient() {
    return client;
  }
