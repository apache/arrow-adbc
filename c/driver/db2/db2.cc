...
// An ADBC driver for IBM Db2 LUW, using DB2 CLI / ODBC.
...
AdbcStatusCode AdbcConnectionGetObjects(struct AdbcConnection* connection, int depth,
                                        ...
                                        struct ArrowArrayStream* out,
                                        struct AdbcError* error) {
  return adbc::db2::Db2Driver::CConnectionGetObjects(connection, depth, catalog,
                                                     db_schema, table_name, table_types,
...
AdbcStatusCode AdbcConnectionGetStatistics(struct AdbcConnection* connection,
                                           ...
                                           struct ArrowArrayStream* out,
                                           struct AdbcError* error) {
  return adbc::db2::Db2Driver::CConnectionGetStatistics(
...
AdbcStatusCode AdbcConnectionGetTableTypes(struct AdbcConnection* connection,
                                           struct ArrowArrayStream* out,
                                           struct AdbcError* error) {
  return adbc::db2::Db2Driver::CConnectionGetTableTypes(connection, out, error);
}
...
AdbcStatusCode AdbcStatementSetSubstraitPlan(struct AdbcStatement* statement,
                                             ...
                                             struct AdbcError* error) {
  return adbc::db2::Db2Driver::CStatementSetSubstraitPlan(statement, plan, length, error);
}
