...
{
    /// <summary>
    /// Provides an implementatio of <see cref="AdbcStatement11"/> which can instrument tracing activity.
    /// </summary>
    /// <param name="activitySource">The <see cref="System.Diagnostics.ActivitySource"/> to add trace activity on.</param>
    public abstract class TracingStatement11(ActivitySource? activitySource) : AdbcStatement11, ITracingObject
    {
