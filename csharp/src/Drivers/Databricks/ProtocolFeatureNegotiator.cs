...
namespace Apache.Arrow.Adbc.Drivers.Databricks
{
    ...
    internal static class ProtocolFeatureNegotiator
    {
        ...
        * - Initial namespace support, driver will fallback to setting default namespace (e.g. SET CATALOG) if not supported (TODO)
        * - resultRowLimit (not implemented)
        * - resultSetMetadata shortcut (not implemented)
        * - Multiple catalogs support, server-side will determine if this can be enabled (TODO)
        */
        ...
        */
        ...
        /**
        * V6 introduced the following features:
        * - LZ4 compression in results, client should check version to determine if this is supported explicitly
        */
