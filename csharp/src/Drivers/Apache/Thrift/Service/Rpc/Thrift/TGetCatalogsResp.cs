...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  internal partial class TGetCatalogsResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp454 = new TStruct("TGetCatalogsResp");
    ...
    {
      var tmp456 = new StringBuilder("TGetCatalogsResp(");
      if((Status != null))
      {
        tmp456.Append(", Status: ");
        Status.ToString(tmp456);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp456.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp456);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        tmp456.Append(", DirectResults: ");
        DirectResults.ToString(tmp456);
      }
      tmp456.Append(')');
