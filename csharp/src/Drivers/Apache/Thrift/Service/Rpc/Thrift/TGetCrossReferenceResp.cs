...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  public partial class TGetCrossReferenceResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp514 = new TStruct("TGetCrossReferenceResp");
    ...
    {
      var tmp516 = new StringBuilder("TGetCrossReferenceResp(");
      if((Status != null))
      {
        tmp516.Append(", Status: ");
        Status.ToString(tmp516);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp516.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp516);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        tmp516.Append(", DirectResults: ");
        DirectResults.ToString(tmp516);
      }
      tmp516.Append(')');
