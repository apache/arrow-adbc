...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  public partial class TGetTablesResp : TBase
  {
    ...
    public TGetTablesResp(global::Apache.Hive.Service.Rpc.Thrift.TStatus @status) : this()
    {
      this.Status = @status;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp474 = new TStruct("TGetTablesResp");
    ...
    {
      var tmp476 = new StringBuilder("TGetTablesResp(");
      if((Status != null))
      {
        tmp476.Append(", Status: ");
        Status.ToString(tmp476);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp476.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp476);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        tmp476.Append(", DirectResults: ");
        DirectResults.ToString(tmp476);
      }
      tmp476.Append(')');
