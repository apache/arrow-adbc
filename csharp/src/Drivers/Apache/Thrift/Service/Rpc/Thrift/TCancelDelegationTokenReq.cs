  ...
  public partial class TCancelDelegationTokenReq : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        {
          tmp576.Name = "delegationToken";
          tmp576.Type = TType.String;
          tmp576.ID = 2;
          await oprot.WriteFieldBeginAsync(tmp576, cancellationToken);
    ...
    {
      var tmp577 = new StringBuilder("TCancelDelegationTokenReq(");
      if((SessionHandle != null))
      {
        tmp577.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp577);
      }
      if((DelegationToken != null))
      {
        tmp577.Append(", DelegationToken: ");
        DelegationToken.ToString(tmp577);
      }
      if((SessionConf != null) && __isset.sessionConf)
      {
        tmp577.Append(", SessionConf: ");
        SessionConf.ToString(tmp577);
      }
      tmp577.Append(')');
