...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  internal partial class TGetTableTypesResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp482 = new TStruct("TGetTableTypesResp");
    ...
    {
      var tmp484 = new StringBuilder("TGetTableTypesResp(");
      if((Status != null))
      {
        tmp484.Append(", Status: ");
        Status.ToString(tmp484);
      }
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp484.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp484);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        tmp484.Append(", DirectResults: ");
        DirectResults.ToString(tmp484);
      }
      tmp484.Append(')');
