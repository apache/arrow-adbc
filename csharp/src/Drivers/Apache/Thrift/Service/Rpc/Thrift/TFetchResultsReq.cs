  ...
  internal partial class TFetchResultsReq : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        {
          tmp560.Name = "fetchType";
          tmp560.Type = TType.I16;
          tmp560.ID = 4;
          await oprot.WriteFieldBeginAsync(tmp560, cancellationToken);
        ...
        {
          tmp560.Name = "includeResultSetMetadata";
          tmp560.Type = TType.Bool;
          tmp560.ID = 1283;
          await oprot.WriteFieldBeginAsync(tmp560, cancellationToken);
    ...
    {
      var tmp561 = new StringBuilder("TFetchResultsReq(");
      if((OperationHandle != null))
      {
        tmp561.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp561);
      }
      tmp561.Append(", Orientation: ");
      Orientation.ToString(tmp561);
      tmp561.Append(", MaxRows: ");
      MaxRows.ToString(tmp561);
      if(__isset.fetchType)
      {
        tmp561.Append(", FetchType: ");
        FetchType.ToString(tmp561);
      }
      if(__isset.maxBytes)
      {
        tmp561.Append(", MaxBytes: ");
        MaxBytes.ToString(tmp561);
      }
      if(__isset.startRowOffset)
      {
        tmp561.Append(", StartRowOffset: ");
        StartRowOffset.ToString(tmp561);
      }
      if(__isset.includeResultSetMetadata)
      {
        tmp561.Append(", IncludeResultSetMetadata: ");
        IncludeResultSetMetadata.ToString(tmp561);
      }
      tmp561.Append(')');
