  ...
  internal partial class TGetPrimaryKeysReq : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        {
          tmp503.Name = "catalogName";
          tmp503.Type = TType.String;
          tmp503.ID = 2;
          await oprot.WriteFieldBeginAsync(tmp503, cancellationToken);
        ...
        if(__isset.runAsync)
        {
          tmp503.Name = "runAsync";
          tmp503.Type = TType.Bool;
          tmp503.ID = 1282;
          await oprot.WriteFieldBeginAsync(tmp503, cancellationToken);
    ...
    {
      var tmp504 = new StringBuilder("TGetPrimaryKeysReq(");
      if((SessionHandle != null))
      {
        tmp504.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp504);
      }
      if((CatalogName != null) && __isset.catalogName)
      {
        tmp504.Append(", CatalogName: ");
        CatalogName.ToString(tmp504);
      }
      if((SchemaName != null) && __isset.schemaName)
      {
        tmp504.Append(", SchemaName: ");
        SchemaName.ToString(tmp504);
      }
      if((TableName != null) && __isset.tableName)
      {
        tmp504.Append(", TableName: ");
        TableName.ToString(tmp504);
      }
      if((GetDirectResults != null) && __isset.getDirectResults)
      {
        tmp504.Append(", GetDirectResults: ");
        GetDirectResults.ToString(tmp504);
      }
      if(__isset.runAsync)
      {
        tmp504.Append(", RunAsync: ");
        RunAsync.ToString(tmp504);
      }
      if((OperationId != null) && __isset.operationId)
      {
        tmp504.Append(", OperationId: ");
        OperationId.ToString(tmp504);
      }
      if((SessionConf != null) && __isset.sessionConf)
      {
        tmp504.Append(", SessionConf: ");
        SessionConf.ToString(tmp504);
      }
      tmp504.Append(')');
