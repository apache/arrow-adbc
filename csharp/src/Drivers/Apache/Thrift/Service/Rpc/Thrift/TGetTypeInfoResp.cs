...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  internal partial class TGetTypeInfoResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp446 = new TStruct("TGetTypeInfoResp");
    ...
    {
      var tmp448 = new StringBuilder("TGetTypeInfoResp(");
      if((Status != null))
      {
      ...
      if((OperationHandle != null) && __isset.operationHandle)
      {
        tmp448.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp448);
      }
      if((DirectResults != null) && __isset.directResults)
      {
        tmp448.Append(", DirectResults: ");
        DirectResults.ToString(tmp448);
      }
      tmp448.Append(')');
