...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  internal partial class TFetchResultsResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp563 = new TStruct("TFetchResultsResp");
        ...
        {
          tmp564.Name = "hasMoreRows";
          tmp564.Type = TType.Bool;
          tmp564.ID = 2;
          await oprot.WriteFieldBeginAsync(tmp564, cancellationToken);
    ...
    {
      var tmp565 = new StringBuilder("TFetchResultsResp(");
      if((Status != null))
      {
        tmp565.Append(", Status: ");
        Status.ToString(tmp565);
      }
      if(__isset.hasMoreRows)
      {
        tmp565.Append(", HasMoreRows: ");
        HasMoreRows.ToString(tmp565);
      }
      if((Results != null) && __isset.@results)
      {
        tmp565.Append(", Results: ");
        Results.ToString(tmp565);
      }
      if((ResultSetMetadata != null) && __isset.resultSetMetadata)
      {
