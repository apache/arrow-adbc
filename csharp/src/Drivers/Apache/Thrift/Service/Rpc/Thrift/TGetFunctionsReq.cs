  ...
  internal partial class TGetFunctionsReq : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        ...
        {
          tmp495.Name = "catalogName";
          tmp495.Type = TType.String;
          tmp495.ID = 2;
          await oprot.WriteFieldBeginAsync(tmp495, cancellationToken);
        ...
        if(__isset.runAsync)
        {
          tmp495.Name = "runAsync";
          tmp495.Type = TType.Bool;
          tmp495.ID = 1282;
          await oprot.WriteFieldBeginAsync(tmp495, cancellationToken);
    ...
    {
      var tmp496 = new StringBuilder("TGetFunctionsReq(");
      if((SessionHandle != null))
      {
        tmp496.Append(", SessionHandle: ");
        SessionHandle.ToString(tmp496);
      }
      if((CatalogName != null) && __isset.catalogName)
      {
        tmp496.Append(", CatalogName: ");
        CatalogName.ToString(tmp496);
      }
      if((SchemaName != null) && __isset.schemaName)
      {
        tmp496.Append(", SchemaName: ");
        SchemaName.ToString(tmp496);
      }
      if((FunctionName != null))
      {
        tmp496.Append(", FunctionName: ");
        FunctionName.ToString(tmp496);
      }
      if((GetDirectResults != null) && __isset.getDirectResults)
      {
        tmp496.Append(", GetDirectResults: ");
        GetDirectResults.ToString(tmp496);
      }
      if(__isset.runAsync)
      {
        tmp496.Append(", RunAsync: ");
        RunAsync.ToString(tmp496);
      }
      if((OperationId != null) && __isset.operationId)
      {
        tmp496.Append(", OperationId: ");
        OperationId.ToString(tmp496);
      }
      if((SessionConf != null) && __isset.sessionConf)
      {
        tmp496.Append(", SessionConf: ");
        SessionConf.ToString(tmp496);
      }
      tmp496.Append(')');
