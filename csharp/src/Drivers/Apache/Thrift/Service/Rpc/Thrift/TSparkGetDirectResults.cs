...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  public partial class TSparkGetDirectResults : TBase
  {
    ...
    {
      var tmp369 = new StringBuilder("TSparkGetDirectResults(");
      tmp369.Append(", MaxRows: ");
      MaxRows.ToString(tmp369);
      if(__isset.maxBytes)
      {
        tmp369.Append(", MaxBytes: ");
        MaxBytes.ToString(tmp369);
      }
      tmp369.Append(')');
