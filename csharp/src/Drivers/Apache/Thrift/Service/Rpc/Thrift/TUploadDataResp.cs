...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  internal partial class TUploadDataResp : TBase
  {
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp467 = new TStruct("TUploadDataResp");
    ...
    {
      var tmp469 = new StringBuilder("TUploadDataResp(");
      if((Status != null))
      {
        tmp469.Append(", Status: ");
        Status.ToString(tmp469);
      }
      if((OperationHandle != null))
      {
        tmp469.Append(", OperationHandle: ");
        OperationHandle.ToString(tmp469);
      }
      tmp469.Append(')');
