...
namespace Apache.Hive.Service.Rpc.Thrift
{
  ...
  public partial class TGetSchemasResp : TBase
  {
    ...
    {
      var tmp470 = new TGetSchemasResp();
      if ((Status != null))
      {
        tmp470.Status = (global::Apache.Hive.Service.Rpc.Thrift.TStatus)this.Status.DeepCopy();
      }
      if ((OperationHandle != null) && __isset.operationHandle)
      {
        tmp470.OperationHandle = (global::Apache.Hive.Service.Rpc.Thrift.TOperationHandle)this.OperationHandle.DeepCopy();
      }
      tmp470.__isset.operationHandle = this.__isset.operationHandle;
      if ((DirectResults != null) && __isset.directResults)
      {
        tmp470.DirectResults = (global::Apache.Hive.Service.Rpc.Thrift.TSparkDirectResults)this.DirectResults.DeepCopy();
      }
      tmp470.__isset.directResults = this.__isset.directResults;
      return tmp470;
    }
    ...
    public async global::System.Threading.Tasks.Task WriteAsync(TProtocol oprot, CancellationToken cancellationToken)
    {
      ...
      try
      {
        var tmp471 = new TStruct("TGetSchemasResp");
    ...
    {
      var tmp473 = new StringBuilder("TGetSchemasResp(");
      if ((Status != null))
      {
        tmp473.Append(", Status: ");
        Status.ToString(tmp473);
      }
      if ((OperationHandle != null) && __isset.operationHandle)
      {
      ...
      if ((DirectResults != null) && __isset.directResults)
      {
        tmp473.Append(", DirectResults: ");
        DirectResults.ToString(tmp473);
      }
      tmp473.Append(')');
