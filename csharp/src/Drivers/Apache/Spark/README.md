...
| `adbc.apache.enable_server_certificate_validation` | If ssl server certificate validation needs to enabled or not. One of `True`, `False`. If set to False, all certificate validation errors are ignored | `True` |
