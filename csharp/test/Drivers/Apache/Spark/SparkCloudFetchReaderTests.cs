...
{
    /// <summary>
    /// Tests for the SparkCloudFetchReader with mocked HTTP responses.
    /// </summary>
    public class SparkCloudFetchReaderTests : IDisposable
    {
        private readonly string _testDataDir;
        private readonly HttpClient _httpClient;
        private readonly Mock<HttpMessageHandler> _mockHttpHandler;

        public SparkCloudFetchReaderTests()
        {
            // Create a test data directory
            _testDataDir = Path.Combine(Path.GetTempPath(), "SparkCloudFetchReaderTests");
        ...
        /// <summary>
        /// Creates a test Arrow file with sample data.
        /// </summary>
        ...
        /// <summary>
        /// Tests that the SparkCloudFetchReader can read data from URLs.
        /// </summary>
        [Fact]
        public async Task TestCloudFetchReaderReadsData()
        {
            // Create test Arrow data
            byte[] arrowData = CreateTestArrowData();

            // Set up the mock HTTP handler to return our test data
            string testUrl = "https://example.com/test.arrow";
            _mockHttpHandler.Protected()
                ...
                .ReturnsAsync(new HttpResponseMessage
                {
                    ...
                    Content = new ByteArrayContent(arrowData)
                });
            ...
            // Create the CloudFetchReader with our mocked objects
            var reader = new SparkCloudFetchReader(mockStatement.Object, schema, false);
