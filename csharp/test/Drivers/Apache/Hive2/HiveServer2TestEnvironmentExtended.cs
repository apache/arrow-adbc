...
{
    public class HiveServer2TestEnvironmentExtended : HiveServer2TestEnvironment<ApacheTestConfiguration>
    {
        public class Factory : Factory<HiveServer2TestEnvironmentExtended>
        {
            public override HiveServer2TestEnvironmentExtended Create(Func<AdbcConnection> getConnection) => new(getConnection);
        }

        private HiveServer2TestEnvironmentExtended(Func<AdbcConnection> getConnection) : base(getConnection) { }
