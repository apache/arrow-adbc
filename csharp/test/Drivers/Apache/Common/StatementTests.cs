...
namespace Apache.Arrow.Adbc.Tests.Drivers.Apache.Common
{
        ...
        where TEnv : HiveServer2TestEnvironment<TConfig>
    {
        ...
        public void CanSetOptionPollTime(string value, bool throws = false)
        {
            ...
            if (throws)
            {
                Assert.Throws<ArgumentOutOfRangeException>(() => statement.SetOption(Adbc.Drivers.Apache.Hive2.HiveServer2Statement.Options.PollTimeMilliseconds, value));
            }
            else
            {
                statement.SetOption(Adbc.Drivers.Apache.Hive2.HiveServer2Statement.Options.PollTimeMilliseconds, value);
            }
        }
        ...
        public void CanSetOptionBatchSize(string value, bool throws = false)
        {
            ...
            if (throws)
            {
                Assert.Throws<ArgumentOutOfRangeException>(() => statement!.SetOption(Adbc.Drivers.Apache.Hive2.HiveServer2Statement.Options.BatchSize, value));
            }
            else
            {
                statement.SetOption(Adbc.Drivers.Apache.Hive2.HiveServer2Statement.Options.BatchSize, value);
            }
        }
        ...
        public async Task CanInteractUsingSetOptions()
        {
            ...
            Statement.SetOption(Adbc.Drivers.Apache.Hive2.HiveServer2Statement.Options.PollTimeMilliseconds, "100");
            Statement.SetOption(Adbc.Drivers.Apache.Hive2.HiveServer2Statement.Options.BatchSize, "10");
